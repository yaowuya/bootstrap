define(['table','FixTable'], function(Table,FixTable) {
    var $table = $("#table");
    var tableData = [],
        tableColumn = [];
    ...
    var tableLength=$(".bootstrap-table .fixed-table-body").width(),
        tableHeight=$(".bootstrap-table .fixed-table-body").height();
        // console.log(tableLength,tableHeight);
    FixTable.fixtable("table",2,3,tableLength,tableHeight);

    $(".btn-get").on('click', function(event) {
        event.preventDefault();
        /* Act on the event */
        console.log("2");
        var getVal=$("#table_tableColumnClone").bootstrapTable("getAllSelections");
